  ...
  const Add_Product = async () => {
    try {
      ...
      if (image) {
        ...
        let uploadRes = await fetch("https://e-commerce-h9gr.onrender.com/upload", { method: "POST", body: formData });
      ...
      if (thumbnails.length > 0) {
        ...
        const uploadRes = await fetch("https://e-commerce-h9gr.onrender.com/upload", { method: "POST", body: formData });
      ...
      // Save product
      const res = await fetch("https://e-commerce-h9gr.onrender.com/addproduct", {
        method: "POST",
